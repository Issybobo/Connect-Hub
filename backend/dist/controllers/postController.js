...
var createPostController = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res, next) {
    var _req$body, userId, caption, user, newPost;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _req$body = req.body, userId = _req$body.userId, caption = _req$body.caption;
          _context.prev = 1;
          _context.next = 4;
  ...
  return function createPostController(_x, _x2, _x3) {
...
var createPostWithImagesController = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res, next) {
    var userId, caption, files, user, imageUrls, newPost;
  ...
  return function createPostWithImagesController(_x4, _x5, _x6) {
    return _ref2.apply(this, arguments);
  };
}();
var updatePostController = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res, next) {
    var postId, caption, postToUpdate, updatedPost;
  ...
  return function updatePostController(_x7, _x8, _x9) {
    return _ref3.apply(this, arguments);
  };
}();
var getPostsController = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req, res, next) {
    var userId, user, blockedUserIds, allPosts;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 7:
          ...
          blockedUserIds = user.blockList.map(function (id) {
            return id.toString();
  ...
  return function getPostsController(_x10, _x11, _x12) {
    return _ref4.apply(this, arguments);
  };
}();
var getUserPostsController = /*#__PURE__*/function () {
  ...
  return function getUserPostsController(_x13, _x14, _x15) {
...
var deletePostController = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        ...
        case 4:
          ...
          _context6.next = 8;
          return User.findById(postToDelete.user);
        case 8:
          user = _context6.sent;
          if (user) {
            _context6.next = 11;
        ...
        case 11:
          ...
          user.posts = user.posts.filter(function (postId) {
            return postId.toString() !== postToDelete._id.toString();
          });
          _context6.next = 14;
          return user.save();
        case 14:
        ...
        case 19:
          ...
          console.error("Error deleting post: ".concat(_context6.t0.message));
        case 22:
        case "end":
  ...
  return function deletePostController(_x16, _x17, _x18) {
...
var likePostController = /*#__PURE__*/function () {
  ...
  return function likePostController(_x19, _x20, _x21) {
    return _ref7.apply(this, arguments);
  };
}();
var dislikePostController = /*#__PURE__*/function () {
  ...
  return function dislikePostController(_x22, _x23, _x24) {
    return _ref8.apply(this, arguments);
  };
}();
module.exports = {
  createPostController: createPostController,
  createPostWithImagesController: createPostWithImagesController,
  updatePostController: updatePostController,
  getPostsController: getPostsController,
  getUserPostsController: getUserPostsController,
  deletePostController: deletePostController,
  likePostController: likePostController,
  dislikePostController: dislikePostController
};